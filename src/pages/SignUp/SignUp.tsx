...
export default function SignUp() {
  const [lastAssignedEmployeeId, setLastAssignedEmployeeId] = useState(1);
  const [formData, setFormData] = useState({
    ...
    password: '', // Add the password field here if it's not already in your state
    department: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setLastAssignedEmployeeId(lastAssignedEmployeeId + 1);
      }
    } catch (error) {
